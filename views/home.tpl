...
<div class="content">
    ...
    <div class="block">
        ...
        <form method="post" action="../total.php">
            <div class="li">
                <div class="gh">
                    <p> От:<input type='text' name="date_ot" class='datepicker-here' autocomplete="off" ></p>
                </div>
                <div class="hg">
                    <p> До:<input type='text' name="date_do" class='datepicker-here' autocomplete="off" ></p>
                </div>
            </div>
            ...
            <div class="li">
                ...
                <div class="hg">
                    <p><select name="total_group" id="total_group">
            ...
            {else }
            <input type="hidden" name="total_group" value="<?=$rows_groups[0]['id'] ?>">
            {/if}
            <p>
    ...
    {if $user_role == 'Starosta' || $user_role == 'Admin'}
        ...
        <div class="block">
            ...
            <form method="post" action="../table.php">
                <div class="li">
                    <p> <input type='text' name="date_table" class='datepicker-here' autocomplete="off" ></p>
                </div>
                <div class="li">
                    <div class="gh">
                        <p>Группа</p>
